window.onload = function() {
  ...
  dom['forms'] = {
    perform_order: {
      selfs: document.querySelectorAll('.perform-order-form')
    }
  };

  for (var i = 0; i < dom.forms.perform_order.selfs.length; i++) {
    dom.forms.perform_order.selfs[i].onsubmit = function(event) {
